...
enum {
    ...
    TLS_DECODER_EVENT_SERVER_UNREQUESTED_STATUS_REQUEST_EXTENSION,
    TLS_DECODER_EVENT_SERVER_ENCRYPT_THEN_MAC_WITHOUT_BLOCK_CIPHER,
    TLS_DECODER_EVENT_INVALID_PADDING_EXTENSION,
    TLS_DECODER_EVENT_PADDING_EXTENSION_ECHOED,
